...
const VATReport = () => {
  ...
  const corporateTaxInfo = [
    {
      key: "2",
      label: "Corporate Tax Rates in Kenya",
      children: (
        <div>
          <Title level={5}>Resident Companies</Title>
          <Text>
            <strong>Tax Rate:</strong> 30% of taxable profits.
          </Text>
          <br />
          <Text>
            <strong>Applies to:</strong> Companies incorporated in Kenya or those managed and controlled from Kenya.
          </Text>

          <Title level={5} className="mt-4">Non-Resident Companies</Title>
          <Text>
            <strong>Tax Rate:</strong> 37.5% of taxable profits.
          </Text>
          <br />
          <Text>
            <strong>Applies to:</strong> Companies not incorporated in Kenya but earning income from Kenya.
          </Text>

          <Title level={5} className="mt-4">Corporate Tax Filing Requirements</Title>
          <Text>
            <strong>Tax Year:</strong> The tax year aligns with the calendar year (1st January to 31st December).
          </Text>
          <br />
          <Text>
            <strong>Filing Deadlines:</strong>
            <ul>
              <li>Annual corporate tax returns must be filed by 30th June of the following year.</li>
              <li>Quarterly installment tax payments are due on:
                <ul>
                  <li>20th of the 4th month</li>
                  <li>20th of the 6th month</li>
                  <li>20th of the 9th month</li>
                  <li>20th of the 12th month</li>
                </ul>
              </li>
            </ul>
          </Text>
          ...
          <Text>
            ...
            <ul>
              <li>Installment Tax: Companies are required to make quarterly tax prepayments based on estimated taxable profits.</li>
              <li>Final Tax Payment: Any balance of tax due must be settled when filing the annual return.</li>
            </ul>
          </Text>
        </div>
      ),
