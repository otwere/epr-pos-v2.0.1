...
// Mock data for supplier account balances
const mockData = [
  {
    id: "0001",
    branch: "Nairobi",
...
const SuppliersAccountBalances = () => {
  ...
  const generateReport = () => {
    const { asOfDate, branch, supplierName } = form.getFieldsValue();
    ...
    setLoading(true);
    setTimeout(() => {
      // Filter mock data based on selected branch and supplier name
      ...
      notificationApi.success({
        ...
        description: "Suppliers Account Balances generated successfully.",
        placement: "topRight",
  ...
  const exportToPDF = () => {
    ...
    doc.text("Suppliers Account Balances", 70, 30);
    ...
    doc.autoTable({
      startY: 100,
      head: [["Branch", "Supplier Name", "Phone Number", "Current Balance (KES)"]],
    ...
    addFooter();
    doc.save(`suppliers_account_balances_${dayjs().format("DD-MM-YYYY")}.pdf`);
  ...
  const collapseItems = [
    {
      key: "1",
      label: "Suppliers Account Balances",
      children: (
        <>
          <Table
...
export default SuppliersAccountBalances;