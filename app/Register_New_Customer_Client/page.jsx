    ...
    <div className="min-h-screen flex">
                ...
                <>
                  ...
                  <Row gutter={16}>
                    <Col xs={24} md={12}>
                      <Form.Item
                        name="openingBalance"
                        label="Opening Balance outstanding (+ve) advance (-ve) *"
                        rules={[{ required: true, message: "This field is required" }]}
                      >
                        <InputNumber className="w-full" placeholder="Enter opening balance" />
                      </Form.Item>
                    </Col>
                    <Col xs={24} md={12}>
                      <Form.Item
                        ...
                        label="Credit Limit"
                      >
                        <InputNumber className="w-full" placeholder="Enter credit limit" />
                      </Form.Item>
                    </Col>
                  </Row>
                  <Row gutter={16}>
                  ...
                  <Row gutter={16}>
                    <Col xs={24} md={12}>
                      <Form.Item
                        ...
                        rules={[{ required: true, message: "This field is required" }]}
                      >
                        <Input placeholder="Enter active Email Address" />
                      </Form.Item>
                    </Col>
                    <Col xs={24} md={12}>
                      <Form.Item
                    ...
                    <Col xs={24} md={12}>
                      ...
                      >
                        <Select placeholder="Select account type">
                          <Option value="Share Capital Account">Share Capital Account</Option>
                          <Option value="Migration Control">Migration Control</Option>
                        </Select>
                      </Form.Item>
                    </Col>
                  </Row>
                  <Row gutter={16}>
                    <Col xs={24}>
                      ...
                      >
                        <Input.TextArea rows={3} placeholder="Enter address or physical location" />
                      </Form.Item>
                    </Col>
                  </Row>
                  <Divider orientation="left">
                    <FileImageOutlined /> Customer's Shop Photo
                  </Divider>
                  <Form.Item
                    name="shopPhoto"
      ...
      >
        <div className="text-center">
          ...
          <p className="mt-4">Saving customer details...</p>
        </div>
      </Modal>
    </div>
  );
