...
const VATReport = () => {
  ...
  const handleFilterChange = (changedValues, allValues) => {
    const { fromDate, toDate, taxPeriod } = allValues;
    setFilters({
  ...
  const exportToPDF = () => {
    ...
    doc.setFont("helvetica", "bold");
    doc.text(" VAT Report Information", margin.left + 5, 60);
    doc.setFont("helvetica", "normal");
    doc.setFontSize(10);
    ...
    addFooter();
    doc.save(`vat_report_${dayjs().format("DD-MM-YYYY")}.pdf`);

    notificationApi.success({
      message: "PDF Export Complete",
      description: "Your VAT report has been successfully exported.",
      placement: "topRight",
      className: "bg-green-50",
    });
  };
      ...
      children: (
        <>
          <Row gutter={16} className="mb-4">
            <Col span={8} key="total-output-vat">
            ...
            <Col span={8} key="total-input-vat">
